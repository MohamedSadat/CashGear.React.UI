...
export interface StoryFrameProps {
  ...
  difference: string;
  children: ReactNode;
  noteDirection?: 'ltr' | 'rtl';
}

export function StoryFrame({ source, difference, children, noteDirection }: StoryFrameProps) {
  return (
    <section data-cg-story-root="" style={{ display: 'grid', gap: '1rem', maxWidth: 820 }}>
      ...
      <small dir={noteDirection} style={{ color: 'var(--cg-text-secondary)', overflowWrap: noteDirection ? 'anywhere' : undefined }}>
