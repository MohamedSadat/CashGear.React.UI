...
const expected = ['CgButton', 'CgCheckBox', 'CgComboBox', 'CgContextMenu', 'CgDateEdit', 'CgDropDownBox', 'CgDropDownButton', 'CgField', 'CgFlyout', 'CgIcon', 'CgKeyComboBox', 'CgListBox', 'CgLoadingPanel', 'CgMaskedInput', 'CgMenu', 'CgMemo', 'CgNumericEdit', 'CgPopup', 'CgProgressBar', 'CgRadio', 'CgRadioGroup', 'CgSearchBox', 'CgSpinEdit', 'CgSplitButton', 'CgSwitch', 'CgTagBox', 'CgTextBox', 'CgToolbar', 'CgWindow', 'cx', 'useCgContextMenuTarget', 'useCgId', 'useControllableState'];
