...
const expected = ['CgButton', 'CgCheckBox', 'CgField', 'CgIcon', 'CgLoadingPanel', 'CgMemo', 'CgNumericEdit', 'CgProgressBar', 'CgRadio', 'CgRadioGroup', 'CgSearchBox', 'CgSpinEdit', 'CgSwitch', 'CgTextBox', 'cx', 'useCgId', 'useControllableState'];
