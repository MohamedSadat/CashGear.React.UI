...
const expected = ['CgButton', 'CgCheckBox', 'CgComboBox', 'CgField', 'CgIcon', 'CgListBox', 'CgLoadingPanel', 'CgMemo', 'CgNumericEdit', 'CgProgressBar', 'CgRadio', 'CgRadioGroup', 'CgSearchBox', 'CgSpinEdit', 'CgSwitch', 'CgTextBox', 'cx', 'useCgId', 'useControllableState'];
